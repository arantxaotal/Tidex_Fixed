...
#pragma endregion
	...
	private: System::Void Nextbutton_Click(System::Object^ sender, System::EventArgs^ e) {
		try {
			...
			ChartForm^ chart = gcnew ChartForm(comboBox1->Text, fileroute->FileName,nullptr, fileroute->FileName); //se le pasa constructor la ruta del .dat elegida y las unidades y se muestra gráfica;
