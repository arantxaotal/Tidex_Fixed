...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(35, 37);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(68, 74);
			...
			this->label1->Size = System::Drawing::Size(251, 34);
			this->label1->TabIndex = 1;
			this->label1->Text = L"ERROR!  Empty file";
			// 
			// ErrorForm
			// 
			...
			this->ClientSize = System::Drawing::Size(394, 151);
